...
# Thin horizontal wooden plank (atlas col 2, row 1), full-cell collision. Two are
# laid per step (tread + the cell below) so the staircase is a run of horizontal
# wooden blocks, like the original game.
